                    ...
                    <TableCell className="text-center">
                      {(() => {
                        ...
                        const roleSelectOptions = (isSuperAdmin ? [
                          ...
                          { value: "manager", label: "Gerente", description: "Gerencia leads e contatos", bg: "bg-amber-500/10 border-amber-500/30 text-amber-600 dark:text-amber-400", icon: Shield },
